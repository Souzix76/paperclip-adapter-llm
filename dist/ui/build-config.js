...
export const configFields = [
    {
        ...
        required: false,
        helpText: "NIM keys start with `nvapi-`. OpenRouter keys with `sk-or-`. Leave empty for localhost endpoints (Ollama, vLLM unauthenticated).",
    },
    {
        key: "baseUrl",
        label: "Base URL",
        ...
        required: false,
        helpText: "Optional override for the OpenAI-compatible endpoint. Leave empty for OpenRouter default.",
    },
    {
        key: "model",
        label: "Model",
