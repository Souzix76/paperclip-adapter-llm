 ...
 */
export function buildConfig(formValues) {
    const config = {};
    ...
    if (formValues.httpReferer)
        config.httpReferer = formValues.httpReferer;
    if (formValues.xTitle)
        config.xTitle = formValues.xTitle;
    return config;
}
/**
...
export const configFields = [
    {
        ...
        required: false,
        helpText: "OpenAI-compatible endpoint. Leave empty for OpenRouter. Examples: NVIDIA NIM (https://integrate.api.nvidia.com/v1), Ollama (http://localhost:11434/v1).",
    },
    {
        key: "apiKey",
        label: "API Key",
        ...
        required: false,
        helpText: "Provider API key. OpenRouter: https://openrouter.ai/keys. NVIDIA NIM: nvapi-... key. Ollama/vLLM localhost: leave empty.",
    },
    {
        key: "model",
        label: "Model",
        ...
        required: true,
        helpText: 'Select a model or use "openrouter/auto" for OpenRouter auto-routing. Models are loaded dynamically from /models.',
